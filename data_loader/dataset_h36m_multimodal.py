...
class DatasetH36M_multi(Dataset):
    ...
    def prepare_data(self):
        self.data_file = os.path.join('/home/fcx/HMP/HumanMAC-main/data', 'data_3d_h36m.npz')
    ...
    def process_data(self):
        ...
        if self.multimodal_path is None:
            self.data_multimodal = \
                np.load('/home/fcx/HMP/HumanMAC-main/data/data_multi_modal/t_his25_1_thre0.050_t_pred100_thre0.100_filtered.npz',
                        allow_pickle=True)[
                    'data_multimodal'].item()
            data_candi = \
                np.load('/home/fcx/HMP/HumanMAC-main/data/data_multi_modal/data_candi_t_his25_t_pred100_skiprate20.npz', allow_pickle=True)[
                    'data_candidate.npy']
        else:
